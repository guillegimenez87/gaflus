...
$consulta = "SELECT id, usuario, preciototal, estado FROM pedidos";
...
<!--         <h3 class="text-center text-light">Glafus</h3>-->
        <h4 class="text-center text-light"><a href="../profile.php">VOLVER AL PERFIL</a> - <span class="badge badge-danger">PEDIDOS</span> </h4> 
         <br>
         <h4 class="text-center text-light">Lista completa de pedidos del sistema GAFLUS</h4> 
     </header>    
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formPedidos">    
            <div class="modal-body">
                ...
                <label for="usuario" class="col-form-label">ID del cliente:</label>
                <input type="text" class="form-control" id="usuario">
                </div>
                <div class="form-group">
                <label for="preciototal" class="col-form-label">Precio Final</label>
                <input type="number" class="form-control" id="preciototal">
                </div>
                <div class="form-group">
                <label for="estado" class="col-form-label">Estado de entrega:</label>
